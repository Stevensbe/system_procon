...
urlpatterns = [
    ...
    path('api/documentos/<uuid:pk>/bloquear/', views.CaixaEntradaViewSet.as_view({'post': 'bloquear'}), name='api_documento_bloquear'),
    path('api/documentos/<uuid:pk>/desbloquear/', views.CaixaEntradaViewSet.as_view({'post': 'desbloquear'}), name='api_documento_desbloquear'),
