    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='recursos_relatados', to=settings.AUTH_USER_MODEL, verbose_name='Relator')),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['analise'], name='analise_jur_analise_76736b_idx'),
        ),
        migrations.AddIndex(
            model_name='documentojuridico',
            index=models.Index(fields=['tipo_documento'], name='analise_jur_tipo_do_ee3b82_idx'),
        ),
        migrations.AddIndex(
            model_name='documentojuridico',
            index=models.Index(fields=['enviado_por'], name='analise_jur_enviado_908f04_idx'),
        ),
        migrations.AddIndex(
            model_name='parecertecnico',
            index=models.Index(fields=['numero_parecer'], name='analise_jur_numero__e4b6f8_idx'),
        ),
        migrations.AddIndex(
            model_name='parecertecnico',
            index=models.Index(fields=['analise'], name='analise_jur_analise_6e3b8a_idx'),
        ),
        migrations.AddIndex(
            model_name='parecertecnico',
            index=models.Index(fields=['status'], name='analise_jur_status_86b0fe_idx'),
        ),
        migrations.AddIndex(
            model_name='parecertecnico',
            index=models.Index(fields=['elaborado_por'], name='analise_jur_elabora_2d58e5_idx'),
        ),
        migrations.AddIndex(
            model_name='recursoadministrativo',
            index=models.Index(fields=['numero_recurso'], name='analise_jur_numero__d313e3_idx'),
        ),
        migrations.AddIndex(
            model_name='recursoadministrativo',
            index=models.Index(fields=['status'], name='analise_jur_status_f1c40a_idx'),
        ),
        migrations.AddIndex(
            model_name='recursoadministrativo',
            index=models.Index(fields=['relator'], name='analise_jur_relator_31002c_idx'),
        ),
        migrations.AddIndex(
            model_name='recursoadministrativo',
            index=models.Index(fields=['data_protocolo'], name='analise_jur_data_pr_48c841_idx'),
        ),
    ]
