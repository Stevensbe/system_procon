    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auto_infracao', models.ForeignKey(blank=True, help_text='Auto de infração relacionado', null=True, on_delete=django.db.models.deletion.SET_NULL, to='fiscalizacao.autoinfracao')),
                ('multa_relacionada', models.ForeignKey(blank=True, help_text='Multa relacionada ao protocolo', null=True, on_delete=django.db.models.deletion.SET_NULL, to='multas.multa')),
                ('processo_fiscalizacao', models.ForeignKey(blank=True, help_text='Processo de fiscalização relacionado', null=True, on_delete=django.db.models.deletion.SET_NULL, to='fiscalizacao.processo')),
                ...
                ('setor_atual', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='documentos_no_setor', to='protocolo_tramitacao.setor')),
                ('setor_origem', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='documentos_originados', to='protocolo_tramitacao.setor')),
                ('tipo_documento', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='protocolo_tramitacao.tipodocumento')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['protocolo', 'data_tramitacao'], name='protocolo_t_protoco_6ac568_idx'), models.Index(fields=['setor_destino', 'data_recebimento'], name='protocolo_t_setor_d_d8a319_idx')],
            },
        ),
        migrations.AddIndex(
