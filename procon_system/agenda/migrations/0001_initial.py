    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fiscal_responsavel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='eventos_responsavel', to='agenda.fiscal', verbose_name='Fiscal Responsável')),
            ],
            options={
