    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['produto', 'data_coleta'], name='produtos_re_produto_13df51_idx'), models.Index(fields=['cnpj_estabelecimento'], name='produtos_re_cnpj_es_07f645_idx')],
            },
        ),
        migrations.AddIndex(
