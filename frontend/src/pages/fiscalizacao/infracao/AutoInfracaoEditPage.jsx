...
function AutoInfracaoEditPage() {
    ...
    const carregarAuto = async () => {
        try {
            ...
            const dataFormatada = {
                ...response,
                data_fiscalizacao: response.data_fiscalizacao ? response.data_fiscalizacao.split('T')[0] : '',
                data_notificacao: response.data_notificacao ? response.data_notificacao.split('T')[0] : '',
                data_vencimento: response.data_vencimento ? response.data_vencimento.split('T')[0] : '',
            };
            
            setAutoData(dataFormatada);
            
            // Carregar assinaturas existentes
            setSignatures({
                assinatura_fiscal: response.assinatura_fiscal || '',
                assinatura_responsavel: response.assinatura_responsavel || ''
            });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Adicionar assinaturas se foram alteradas
            ...
            navigate(`/fiscalizacao/infracoes/${id}`, { replace: true });
            
        } catch (err) {
            console.error('Erro ao salvar:', err);
            setError(err.message || 'Ocorreu um erro ao atualizar o auto de infração.');
        } finally {
            setSaving(false);
        }
    };
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="bg-white shadow-xl rounded-lg overflow-hidden">
                    ...
                    <div className="bg-blue-600 px-6 py-4">
                        <h1 className="text-2xl font-bold text-white">Editar Auto de Infração</h1>
                        <p className="text-blue-100 mt-1">
                            Número: <span className="font-mono bg-blue-700 px-2 py-1 rounded text-sm">{autoData.numero}</span>
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-8">
                        ...
                        <div className="bg-gray-50 rounded-lg p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <input 
                                        type="text" 
                                        value={autoData.estado || 'AMAZONAS'} 
                                        disabled 
                        ...
                        <div className="flex items-center justify-between pt-6 border-t border-gray-200">
                            ...
                            <div className="flex space-x-3">
                                <button 
                                    type="button"
                                    onClick={() => navigate(`/fiscalizacao/infracoes/${id}`)}
                                ...
                                <button 
                                    type="submit" 
                                    disabled={saving} 
                                    className="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed font-medium flex items-center"
                                >
                                    {saving ? (
                                        <>
...
export default AutoInfracaoEditPage;