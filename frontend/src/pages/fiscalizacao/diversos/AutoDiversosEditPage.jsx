...
import { getAutoDiversosById, atualizarAutoDiversos, consultarCNPJReceita } from '../../../services/fiscalizacaoService';
              ...
              <div className="mt-1 flex flex-col gap-2">
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-3 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700 disabled:bg-gray-400 text-sm font-medium"
                  >
