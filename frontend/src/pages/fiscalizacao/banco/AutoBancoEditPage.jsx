...
import { getAutoBancoById, atualizarAutoBanco, consultarCNPJReceita } from '../../../services/fiscalizacaoService';
...
function AutoBancoEditPage() {
        ...
        const carregarAuto = async () => {
            try {
                ...
                setAutoData(prev => ({
                    ...prev,
                    ...data,
                    data_fiscalizacao: data.data_fiscalizacao || prev.data_fiscalizacao,
                    hora_fiscalizacao: data.hora_fiscalizacao || prev.hora_fiscalizacao
                }));
                setAtendimentos(data.atendimentos_caixa || []);
            } catch (err) {
    ...
    if (loadingData) {
        return (
            <div className="p-8 text-gray-600 dark:text-gray-300">Carregando auto de banco...</div>
        );
    }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await atualizarAutoBanco(id, formData);
            alert(`Auto de Banco "${response.numero || id}" atualizado com sucesso!`);
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="bg-white dark:bg-[#1a1d21] shadow-xl rounded-lg overflow-hidden transition-colors duration-300">
                    ...
                    <div className="bg-blue-600 px-6 py-4">
                        <h1 className="text-2xl font-bold text-white">Editar Auto de Constatação - Banco</h1>
